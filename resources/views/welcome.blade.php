    ...
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p>
                    Next, you will need to add competitors you want to enter in to competitions to your account. Again,
                ...
                <div class="card bg-light shadow">
                     <div class="card-body text-center">
                         ...
                         <p class="lead card-text">
                             Click the button below to sign up as a parent/guardian or competitor over 16. You can add
